...
import java_core.homework8.configuration.ApplicationGlobalState;
import java_core.homework8.dto.WeatherResponse;
import java_core.homework8.enums.Periods;
import java_core.homework8.repository.DatabaseRepository;
import java_core.homework8.repository.DatabaseRepositorySQLiteImpl;
...
public class AccuWeatherProvider implements WeatherProvider {
    ...
    @Override
    public List<java_core.homework8.entity.WeatherData> getAllFromDb() throws SQLException, IOException {
        List<java_core.homework8.entity.WeatherData> weatherDataList = repository.getAllSavedData();
        for (java_core.homework8.entity.WeatherData weatherData : weatherDataList) {
